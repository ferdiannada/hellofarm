    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="transaksi1.php"><i class="fa fa-circle-o"></i> Transaksi Beli</a></li>
            <li><a href="transaksi2.php"><i class="fa fa-circle-o"></i> Transaksi Jual</a></li>
          </ul>
        </li>
      </ul>
    </section>
