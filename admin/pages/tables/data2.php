      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="data2.php"><i class="fa fa-circle-o"></i> Data Suplier</a></li>
          </ul>
        </li>
        <li>
          <a href="produk.php">
        ...
        <li class=" treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="transaksi2.php"><i class="fa fa-circle-o"></i> Transaksi Pemesanan</a></li>
          </ul>
        </li>
      </ul>
    </section>
